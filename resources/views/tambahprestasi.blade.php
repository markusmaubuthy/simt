            ...
            <div class="flex flex-wrap">
                <div class="w-full self-center px-4 bg-slate-300 rounded-xl py-5 shadow-lg">
                    <div class="max-w-xl mx-auto text-center mb-16">
                        <h4 class="font-bold text-teal-500 text-2xl mb-4 sm:text-3xl lg:text-3xl">TAMBAH DATA SISWA</h4>
                    </div>
                    <div>
                        <form action="">
                            <div class="w-full mx-auto lg:w-2/3 ">
                                <div class="w-full px-4 mb-8">
                                    ...
                                    <input type="text" id="nama_siswa" class="w-full bg-slate-200 text-black p-2 rounded-md
                                ...
                                <div class="w-full px-4 mb-8">
                                    ...
                                    <input type="text" id="nisn" class="w-full bg-slate-200 text-black p-2 rounded-md
                                    focus:outline-none focus:ring-teal-500 focus:ring-1 focus:border-teal-500">
                                </div>
                                <div class="w-full px-4 mb-8">
                                    <label class="block mb-2 text-base font-medium text-teal-500 " for="user_avatar">Upload file</label>
                                ...
                                <div class="w-full flex">
                                    ...
                                    transition duration-500 text-white py-2 px-2 rounded full">Tambah</button>
                                </div>
                            </div>
                        </form>
                    </div>
